package indi.df.fmall.passport.controller;
...
import indi.df.fmall.util.JwtUtil;
...
public class PassportController {
    ...
    public String login(UmsMember umsMember, HttpServletRequest request){
        ...
        if(umsMemberLogin != null){
            ...
            // 用jwt制作token
                //用户信息
            String memberId = umsMemberLogin.getId(); //用户id
            String nickname = umsMemberLogin.getNickname(); //用户昵称
