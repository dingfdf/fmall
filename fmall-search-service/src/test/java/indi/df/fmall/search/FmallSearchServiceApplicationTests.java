...
@SpringBootTest
public class FmallSearchServiceApplicationTests {
    ...
    public void put() throws IOException {
        ...
        for (PmsSearchSkuInfo pmsSearchSkuInfo : pmsSearchSkuInfos) {
            Index put = new Index.Builder(pmsSearchSkuInfo).index("fmallpms").type("PmsSkuInfo").id(pmsSearchSkuInfo.getId()+"").build();
